...
class ApiService {
  ...
  static lookupEmail(email) {
    return this.request("GET", `/auth/lookup?email=${encodeURIComponent(email)}`);
  }
  ...
  static forgotPasswordVerifyEmail(email) {
    return this.request("POST", "/auth/forgot-password/verify-email", { email });
  }

  static forgotPasswordVerifyCode(email, code) {
    return this.request("POST", "/auth/forgot-password/verify-code", { email, code });
  }

  static forgotPasswordReset(resetToken, newPassword) {
    return this.request("POST", "/auth/forgot-password/reset", { resetToken, newPassword });
  }
  ...
  static changeStudentPassword(data) {
    return this.request("PUT", "/profile/student/password", data);
  }
  ...
  static changeTeacherPassword(data) {
    return this.request("PUT", "/profile/teacher/password", data);
  }
  ...
  static getTeacherSubjectSessions(subjectCode, options = {}) {
    ...
    return this.request(
      "GET",
      `/attendance/subject/${encodeURIComponent(subjectCode)}/sessions${query ? `?${query}` : ""}`,
    );
  }

  static deleteTeacherSession(subjectCode, sessionId) {
    return this.request(
      "DELETE",
      `/attendance/subject/${encodeURIComponent(subjectCode)}/session/${encodeURIComponent(sessionId)}`,
    );
  }

  static getAttendanceGrid(subjectCode) {
    return this.request(
      "GET",
      `/attendance/subject/${encodeURIComponent(subjectCode)}/grid`,
    );
  }

  static updateAttendanceGrid(subjectCode, updates) {
    return this.request(
      "PUT",
      `/attendance/subject/${encodeURIComponent(subjectCode)}/grid`,
      { updates },
